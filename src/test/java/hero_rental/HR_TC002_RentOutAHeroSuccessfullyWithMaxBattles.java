...
public class HR_TC002_RentOutAHeroSuccessfullyWithMaxBattles extends BaseTest {
    WebDriver driver;
...
//        metamaskPage.clickToAssetsButtonWeb();
        ...
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC002_STEPS_03();

        log.info("----------HT_TC001_STEPS_04");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC002_STEPS_04();

        log.info("----------HT_TC001_STEPS_05");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC002_STEPS_05();
        ...
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC002_STEPS_07();

        log.info("Step : inputBattlesForRent");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.inputBattlesForRent(battlesCurrent);

        log.info("Step : getTextBattlesForRent");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.getTextBattlesForRent(battlesCurrent);

        String rentPrice = "100";
        log.info("----------HT_TC001_STEPS_08");
        rentPage = PageGeneratorManager.getPageGenerator().getRentPage(driver);
        rentPage.HR_TC002_STEPS_08(rentPrice);
